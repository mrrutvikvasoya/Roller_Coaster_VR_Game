...
```
cd existing_repo
git remote add origin https://git.oth-aw.de/a85d/arvr.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.oth-aw.de/a85d/arvr/-/settings/integrations)
